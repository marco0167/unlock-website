...
function Why() {
  return (
    <section className="container m-auto dpb-28">
      <div className="container mx-auto py-20 md:py-42">
        <h2 className="text-[10vw] md:text-[70px] font-sora font-regular text-center leading-none text-neutral-100 flex flex-col gap-y-4 lg:w-4/6 m-auto">
          <span>Private.</span>
      ...
      <div className="flex flex-col gap-20 md:gap-36 items-center md:pt-4">
        <FeatureItem
