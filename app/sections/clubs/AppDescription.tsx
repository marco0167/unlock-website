...
function AppDescription() {
  ...
  return (
    <section className="pt-32">
      <div className="container mx-auto px-5 overflow-hidden sm:pb-38">
        <div className="flex flex-col gap-y-21">
          <FeatureItem
            ...
            image="assets/images/team-dashboard.jpg"
            imgContainerClass="overflow-hidden rounded-[20px]!"
          />
          <FeatureItem
            ...
            image="assets/images/club-dashboard.jpg"
            imgContainerClass="overflow-hidden  rounded-[20px]!"
          />
        </div>
      </div>
      <div className="md:pb-46 py-30 px-5 flex flex-col gap-10 items-center bg-gradient-to-t from-neutral-800 to-90%">
