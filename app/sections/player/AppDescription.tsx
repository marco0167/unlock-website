...
function AppDescription() {
  ...
  return (
    <section className="pt-32">
      <div className="container mx-auto pb-38 not-md:px-5 overflow-hidden">
      ...
      <div className="pb-46 px-5 flex flex-col gap-10 items-center bg-gradient-to-t from-neutral-800 to-90%">
