      ...
      <div className="grid lg:grid-cols-5 2xl:grid-cols-2 2xl:gap-x-26 gap-x-16 md:gap-y-14 gap-y-10">
        ...
        <div className="grid md:grid-cols-1 sm:grid-cols-2 grid-cols-1 gap-x-6 gap-y-6 not-2xl:col-span-3">
          <ProfileCards
            ...
            qualifications="CoFounder | Sport Psychologist"
      ...
      <div className="grid lg:grid-cols-5 2xl:grid-cols-2 2xl:gap-x-26 gap-x-16 md:gap-y-14 gap-y-10">
        ...
        <div className="grid md:grid-cols-1 sm:grid-cols-2 grid-cols-1 gap-x-6 gap-y-6 not-2xl:col-span-3">
          <ProfileCards
            ...
            description="Sam Holden is a former footballer turned high-growth tech lead, as Founder of Unlock he is dedicated to making sport psychology accessible to every athlete."
