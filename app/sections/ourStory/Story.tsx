    ...
    <section className="bg-neutral-300 md:py-44 py-24">
      <div className="container mx-auto px-4 text-background flex flex-col md:gap-y-22 gap-y-14">
        <div className="grid lg:grid-cols-2 md:gap-y-10 gap-y-6">
          <h3 className=" font-sora font-regular text-5xl">Our Mission</h3>
          <div className="font-inter font-regular md:text-2xl text-base flex flex-col md:gap-y-6 gap-y-4">
            ...
            <p>
              Our goal is to become the sport psychologist in your pocket. The
              complete system you can turn to for learning, building habits,
              staying accountable and performing at your best.
            </p>
          </div>
        </div>

        <div className="grid lg:grid-cols-2 md:gap-y-10 gap-y-6">
          <h3 className=" font-sora font-regular text-5xl">Our Story</h3>
          <div className="font-inter font-regular md:text-2xl text-base flex flex-col md:gap-y-6 gap-y-4">
            ...
            <p>
              ...
              was shaped by both opportunity and setback. After collapsing at 13
              and being told he’d never play again, he rebuilt his body and mind
              without the help of a sport psychologist - not being able to
              afford the help he needed - to play for academies such as
              Manchester United & Southampton. An experience that planted the
              seed for Unlock, for the highs and lows.
            </p>
            <p>
